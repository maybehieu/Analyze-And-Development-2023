...
CREATE TABLE Payment (ID int(10) NOT NULL AUTO_INCREMENT, Fees float NOT NULL, Names varchar(255), IDCOD int(10), Currency varchar(255), IDInter int(10), AccountNumber varchar(255), token varchar(255), IDCredit int(10), CardNumber varchar(255), Type varchar(255), PRIMARY KEY (ID));
