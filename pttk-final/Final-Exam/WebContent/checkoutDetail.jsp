<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <head>
            ...
            <title>Checkout Details | Ecommerce</title>
                                    ...
                                    <tr>
                                        <td class="item">
                                            <div class="d-flex"> <img src="images/book.jpg" alt="">
                                                <div class="pl-2">${item.book.title}<div class="text-uppercase new">
                                                        <span class="fas fa-star"></span>new</div>
                    ...
                    <div class="col-4 text-center">
                        ...
                        <select name="payment">
                            <c:forEach var="pay" items="${payments}">
                                <option value="${pay.ID}">${pay.ID}, <td>${pay.names}</td>
                                </option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="col-4 text-center">
                        ...
                        <select name="shipment">
                            <c:forEach var="ship" items="${shipments}">
                                <option value="${ship.ID}">${ship.ID}, <td>${ship.names}</td>
                                </option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="col-4 text-center">
                        ...
                        <select name="voucher">
                            <c:forEach var="vou" items="${vouchers}">
                                <option value="${vou.ID}">${vou.ID}, <td>${vou.names}</td>
                                </option>
                            </c:forEach>
                        </select>
                    </div>
