...
<head>
    ...
    <title>Checkout Details | Ecommerce</title><link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="small-container">
                    ...
                    <tr>
                        <td class="item">
                            <div class="d-flex"> <img src="images/book.jpg" alt="">
                                <div class="pl-2">${item.book.title}<div class="text-uppercase new"><span class="fas fa-star"></span>new</div>
                        ...
                        <td class="d-flex flex-column"><span class="red">${item.price}</span> <del class="cross">-${item.discount}đ</del> </td>
                        <td class="font-weight-bold"> ${bookPrice[i.index]-item.discount*bookQuantity[i.index]}d</td>
                    </tr>
                  </c:forEach>
                </tbody>
            </table>
        ...
        <form action="order" style="margin: 0px 20px;">
        <div class="row">
        ...
        <div class="text-center">
            <input class="btn btn-success" style="width: 10%; height: auto;" type="submit" value="Order">
        </div>
        </form>
    </div>
    <section id="maps">
