...
<head>
    ...
    <title>Detail Products | Ecommerce</title><link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-8">
                <h1>${bookitem.book.title}</h1><h2> - ${bookitem.book.author.name}</h2>
                <h4>Price: ${bookitem.price}đ</h4><h5 style="color: red;"> (-${bookitem.discount}đ)</h5>
