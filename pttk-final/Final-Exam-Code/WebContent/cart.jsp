...
<head>
    ...
    <title>Cart | Ecommerce</title><link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&display=swap" rel="stylesheet">
                                ...
                                <div class="pl-2">${item.book.title}<div class="text-uppercase new"><span class="fas fa-star"></span>new</div>
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <form action="dellBitemCart">
										  ...
										  <input type="submit" value="Remove" style="padding: 0; border: none; background: none;">
										</form>
                                    </div>
                                </div>
                        </td>
