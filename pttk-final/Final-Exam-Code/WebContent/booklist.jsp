    ...
    <div class="header">
        <div class="container">
            <div class="navbar">
                ...
                <form action="search">
			      <input name="keywords" type="text" style="display:inline-block; width: 80%;" placeholder="Search.." name="search">
                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn btn-primary text-center" style="margin: 0px 0px;" onclick="addbook(${product.ID}, 1, 'book')">Add
                                to Cart</div>
                            <form action="productdetails">
                        	  <input type = "hidden" name = "id" value = ${product.ID} />
							  <input type="submit" class="text-center btn btn-primary btn-lg active" style="height: auto;" value="Details">
                            </form>
